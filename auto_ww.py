...
imdir = './stargan_data/white_women/'
...
autoencoder.save("ww_autoencoder_model.model")

# from google.colab.patches import cv2_imshow
#%%
# test and save some random images.
rng = default_rng()
file_list = os.listdir('./stargan_data/white_women/')  
...
for i,test_img in enumerate(test_imgs):
    ...
    cv2.imwrite(f"ww_autoencoder_test_{i}_{test_img}", ae_out)
